...
if (!class_exists('Outpaceseo_Schema_Job_Posting')) {

    /**
     * Outpaceseo Schemas Initialization
     */
    class Outpaceseo_Schema_Job_Posting
    {
        ...
        public static function render($data, $post)
        {
            ...
            if ((isset($data['orgnization-name']) && !empty($data['orgnization-name'])) ||
                ...
                if (isset($data['organization-logo']) && !empty($data['organization-logo'])) {
                    ...
                    $schema['hiringOrganization']['logo'] = Outpaceseo_Schema_Template::get_image_schema($data['organization-logo'], 'ImageObject');
                }
            }
            ...
            return apply_filters('outpaceseo_schema_job_posting', $schema, $data, $post);
        }
    }
}
