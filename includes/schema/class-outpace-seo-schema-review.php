...
if (!class_exists('Outpaceseo_Schema_Review')) {

    /**
     * Outpaceseo Schemas Initialization
     */
    class Outpaceseo_Schema_Review
    {
        ...
        public static function render($data, $post)
        {
            ...
            switch ($data['schema-type']) {
                ...
                case 'bsf-aiosrs-event':
                    ...
                    if (isset($data['bsf-aiosrs-event-image']) && !empty($data['bsf-aiosrs-event-image'])) {
                        $schema['itemReviewed']['image'] = Outpaceseo_Schema_Template::get_image_schema($data['bsf-aiosrs-event-image']);
                    }
                    ...
                    if (
                        isset($data['bsf-aiosrs-event-online-location']) && !empty($data['bsf-aiosrs-event-online-location']) &&
                ...
                case 'bsf-aiosrs-local-business':
                    ...
                    if (isset($data['bsf-aiosrs-local-business-image']) && !empty($data['bsf-aiosrs-local-business-image'])) {
                        ...
                        $schema['itemReviewed']['image'] = Outpaceseo_Schema_Template::get_image_schema($data['bsf-aiosrs-local-business-image']);
                    }
                ...
                case 'bsf-aiosrs-recipe':
                    ...
                    if (isset($data['bsf-aiosrs-recipe-image']) && !empty($data['bsf-aiosrs-recipe-image'])) {
                        $schema['itemReviewed']['image'] = Outpaceseo_Schema_Template::get_image_schema($data['bsf-aiosrs-recipe-image']);
                    }
                    ...
                    if (isset($data['bsf-aiosrs-recipe-video-name']) && !empty($data['bsf-aiosrs-recipe-video-name'])) {
                        ...
                        if (isset($data['bsf-aiosrs-recipe-video-image']) && !empty($data['bsf-aiosrs-recipe-video-image'])) {
                            $schema['itemReviewed']['video']['thumbnailUrl'] = Outpaceseo_Schema_Template::get_image_schema($data['bsf-aiosrs-recipe-video-image']);
                        }
                ...
                case 'bsf-aiosrs-software-application':
                    ...
                    if (true === apply_filters('outpaceseo_remove_software_application_offers_review_type', true)) {
                        $schema['itemReviewed']['offers']['@type'] = 'Offer';
                ...
                case 'bsf-aiosrs-product':
                    ...
                    if (isset($data['bsf-aiosrs-product-image']) && !empty($data['bsf-aiosrs-product-image'])) {
                        $schema['itemReviewed']['image'] = Outpaceseo_Schema_Template::get_image_schema($data['bsf-aiosrs-product-image']);
                    }
                    ...
                    if (apply_filters('outpaceseo_remove_product_offers', true)) {
                        $schema['itemReviewed']['offers']['@type'] = 'Offer';
                        $schema['itemReviewed']['offers']['price'] = '0';
                ...
                case 'bsf-aiosrs-movie':
                    ...
                    if (isset($data['bsf-aiosrs-movie-image']) && !empty($data['bsf-aiosrs-movie-image'])) {
                        $schema['itemReviewed']['image'] = Outpaceseo_Schema_Template::get_image_schema($data['bsf-aiosrs-movie-image']);
                    }
            ...
            return apply_filters('outpaceseo_schema_review', $schema, $data, $post);
        }
    }
}
